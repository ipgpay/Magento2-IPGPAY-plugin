                ...
                $.ajax({
                    ...
                    if (isUsePopup == "1") {
                        ...
                        $.ajax({
                            ...
                            popupContainer.innerHTML = '' + '<div style="border-radius: 6px;position: relative; background-color: #c5e0f3;width:375px;height:500px;margin: 25px auto;border:2px solid #fff;text-align:center;">' + '<div style="height:20px;padding:5px;margin-top:-20px;position:relative;box-sizing:border-box;">' + '<button type="button" class="pupayment-close-button" style="position:absolute;top:25px;right:10px;-webkit-appearance: none;padding: 0;cursor: pointer;background: 0 0;border: 0;font-size: 21px;font-weight: 700;line-height: 1;color: #000;text-shadow: 0 1px 0 #fff;opacity: .2;">' + '<span style="cursor: pointer;font-size: 21px;font-weight: 700;line-height: 1;color: #000;text-shadow: 0 1px 0 #fff;text-align:right;">×</span></button>' + '</div>' + '<iframe src="' + data + '" style="width:100%;height:495px;background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="100%" height="100%"></iframe>' + '</div>';
